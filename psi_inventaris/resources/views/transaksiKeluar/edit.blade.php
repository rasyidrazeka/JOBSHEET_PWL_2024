...
@section('title', 'Edit Data Transaksi Keluar')
@section('content')
        ...
        <div class="card-body">
            ...
            @else
                <form method="POST" action="{{ url('/transaksiKeluar/' . $transaksi_keluar->transaksiKeluar_id) }}"
                    class="form-horizontal" enctype="multipart/form-data" id="edit-transaksiKeluar">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-11">
                            ...
                            <input type="hidden" name="barang_id" id="barang_id" value="{{ $transaksi_keluar->barang_id }}">
                            @error('barang_id')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
